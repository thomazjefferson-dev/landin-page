...
;
const metadata = {
    title: "node crie - Software House | Desenvolvimento de Sites, Apps e Sistemas",
    description: "Transformamos suas ideias em soluções digitais. Desenvolvimento de sites, landing pages, sistemas e aplicativos mobile com UI/UX profissional.",
    generator: "v0.app",
    icons: {
        icon: [
            {
